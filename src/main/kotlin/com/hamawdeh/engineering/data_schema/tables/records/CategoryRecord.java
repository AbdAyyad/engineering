...
public class CategoryRecord extends UpdatableRecordImpl<CategoryRecord> implements Record4<Integer, Integer, String, LocalDateTime> {
    ...
    @Override
    public CategoryRecord values(Integer value1, Integer value2, String value3, LocalDateTime value4) {
        value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
     ...
     */
    public CategoryRecord(Integer id, Integer code, String name, LocalDateTime created) {
        super(Category.CATEGORY);

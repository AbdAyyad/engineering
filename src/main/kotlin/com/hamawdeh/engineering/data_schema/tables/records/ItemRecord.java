...
public class ItemRecord extends UpdatableRecordImpl<ItemRecord> implements Record4<Integer, Integer, String, LocalDateTime> {
    ...
    @Override
    public ItemRecord values(Integer value1, Integer value2, String value3, LocalDateTime value4) {
        value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
     ...
     */
    public ItemRecord(Integer id, Integer serialId, String description, LocalDateTime created) {
        super(Item.ITEM);

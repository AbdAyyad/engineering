...
public class ItemRecord extends UpdatableRecordImpl<ItemRecord> implements Record5<Integer, Integer, String, String, LocalDateTime> {
    ...
    /**
     * Setter for <code>public.item.serial_id</code>.
     */
    public void setSerialId(Integer value) {
        set(1, value);
    }

    /**
     * Getter for <code>public.item.serial_id</code>.
     */
    ...
    @Override
    public ItemRecord values(Integer value1, Integer value2, String value3, String value4, LocalDateTime value5) {
        value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
     ...
     */
    public ItemRecord(Integer id, Integer serialId, String code, String description, LocalDateTime created) {
        super(Item.ITEM);
